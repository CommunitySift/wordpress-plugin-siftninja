...
== Description ==
Sift Ninja is a free plugin that provides a powerful yet simple way to automatically moderate and filter comments on your WordPress site. 
Sift Ninja can evaluate incoming comments for Vulgarity (Profanity) Bullying, Racism, Violence (Fighting), Sexting, and PII (Personally Identifiable Information. 
...
== Fork on GitHub ==
You can see the code for Sift Ninja Wordpress Plugin on GitHub, https://github.com/CommunitySift/wordpress-plugin-siftninja
