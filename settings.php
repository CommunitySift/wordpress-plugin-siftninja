...
if(!class_exists('Sift_Ninja_Settings'))
{
	class Sift_Ninja_Settings
	{
        ...
        public function settings_section_text()
        {
            ...
            echo '<h1>These settings are for configuring Sift Ninja</h1>'
            .'If you do not have a Sift ninja account, you can visit'
            .' <a href="http://www.siftninja.com">Sift Ninja</a> '
        ...
        public function settings_field_input_text($args)
        {
            ...
            //error_log("value: $value, field: $field, default: $default");
            // echo a proper input type="text"
            echo sprintf('<input type="text" name="%s" id="%s" value="%s" /> <span>%s</span>', $field, $field, $value, $help_text);
        ...
        public function settings_field_input_checkbox($args)
        {
            ...
            echo sprintf('<input type="checkbox" name="%s" id="%s" value="%s" %s /> <span>%s</span>', $field, $field, '1', $checked, $help_text);
        } // END public function settings_field_input_text($args)
